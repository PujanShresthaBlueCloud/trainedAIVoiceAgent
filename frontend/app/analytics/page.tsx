  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Track performance metrics and usage statistics</p>
      </div>
      <div className="flex flex-col items-center justify-center py-24 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
        <BarChart3 className="w-12 h-12 text-gray-400 dark:text-gray-600 mb-4" />
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm text-center">
          View call volume, success rates, average duration, and other key metrics across your AI agents.
        </p>
      </div>
    </div>
  );
