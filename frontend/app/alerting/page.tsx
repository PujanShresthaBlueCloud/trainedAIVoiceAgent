  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Configure alerts and notifications for your AI agents</p>
      </div>
      <div className="flex flex-col items-center justify-center py-24 bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm text-center">
          Set up real-time alerts for failed calls, low quality scores, and other important events.
        </p>
      </div>
    </div>
  );
