  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Overview of your voice AI platform</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {statCards.map((card) => {
          ...
          return (
            <div
              key={card.label}
              className="bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6"
            >
